...
import { UpdateOrderStatusButton } from "./update-status-button";
import { 
  Package, 
  Search, 
  Eye,
                            ...
                            {nextStatuses.length > 0 ? (
                              nextStatuses.map((nextStatus) => (
                                <UpdateOrderStatusButton
                                  ...
                                  label={statusMap[nextStatus]?.label || nextStatus}
                                />
                              ))
                            ) : (
                              <span className="text-xs text-gray-400">لا يوجد تحديثات</span>
                            )}
                          </div>
                        </td>
                      </tr>
